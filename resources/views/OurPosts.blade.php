                            ...
                            <div aria-label="group of cards" class="w-full">
                                ...
                                <div class="flex flex-col lg:flex-row mx-auto bg-white shadow rounded">
                                    <div class="w-full lg:w-1/2 px-12 flex flex-col items-center py-10">
                                        <a tabindex="0" class="focus:outline-none focus:opacity-75 hover:opacity-75 text-gray-800  cursor-pointer focus:underline"><h2 class=" text-xl tracking-normal font-medium mb-1">{{ $row->description }}</h2></a>
                                ...
                                <span class="cursor-pointer mr-1 text-gray-600 ">
                                    <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/full_width_3_section_card-svg4.svg" alt="icon"/>
                                    ...
                                    <div class="w-full lg:w-1/2 flex-col flex justify-center items-center px-12 py-8">
                                        <h2 class="text-center text-2xl text-gray-800  font-medium tracking-normal">{{ $row->title }}</h2>
                                        <a href="readpost/{{$row->id}}" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-indigo-600 ml-0 md:ml-5 bg-indigo-700 dark:bg-indigo-600 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-3 md:px-6 py-2 text-sm">Read More</a>
                                    </div>
                                </div>
                                <!-- Card code block end -->
                            </div>
