...
@section('content')
    <div class="flex justify-center w-full sm:px-6">
        <div class="px-4 md:px-10 pt-6 md:pt-12 md:pb-4 pb-7">
            <p class="text-center text-2xl font-semibold mb-10">Add New Post</p>
            <form method="post" action="{{ route('posts.store') }}" enctype="multipart/form-data" class="mt-11">
                @csrf
                ...
                <div class="flex items-center space-x-9">
                    <textarea  type="text" name="contenu" placeholder="contenu"
                           class="focus:ring-2 focus:ring-gray-400 w-full focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white  border rounded border-gray-200 my-5  min-h-[150px] "></textarea>
                </div>
                <div class="flex items-center space-x-9">
                    <textarea  type="text" name="description" placeholder="add short description"
                               class="focus:ring-2 focus:ring-gray-400 w-full focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white  border rounded border-gray-200 my-5  min-h-[100px] "></textarea>
                </div>
                <div class="flex items-center space-x-9">
