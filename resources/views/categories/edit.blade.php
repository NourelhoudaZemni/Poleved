...
@section('content')
            ...
            <div class="flex justify-center w-full sm:px-6 mt-10">
                <div class="px-4 md:px-10 pt-6 md:pt-12 md:pb-4 pb-7">
                    <p class="text-center text-2xl font-semibold mb-10">Edit Balade's Category</p>
                    <form method="post" action="{{ route('categories.update', $categories->id) }}" enctype="multipart/form-data" class="mt-11">
                        @csrf
                        @method('PUT')
                        <div class="flex items-center space-x-9">
                            <input value="{{ $categories->category_name }}" type="text" name="category_name" placeholder="Name of category"
