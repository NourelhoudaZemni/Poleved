...
@section('content')
    ...
    <h2 class="flex justify-center focus:outline-none text-4xl font-bold text-indigo-900 mt-10">Don't Miss Our Balades</h2>
    @if(count($data) > 0)
                            ...
                            <div aria-label="group of cards" class="w-full">
                                ...
                                <span class="cursor-pointer mr-1 text-gray-600 ">
                                    ...
                                    <div class="w-full lg:w-1/2 flex-col flex justify-center items-center px-12 py-8">
                                        <h2 class="text-center text-2xl text-gray-800  font-medium tracking-normal">{{ $row->quantity }}</h2>
                                        <h2 class="text-center text-sm text-gray-600  font-normal mt-2 mb-4 tracking-normal">Number Of Places</h2>
                                        <h2 class="text-center text-2xl text-gray-800  font-medium tracking-normal">{{ $row->price }} $</h2>
                                        <h2 class="text-center text-sm text-gray-600  font-normal mt-2 mb-4 tracking-normal">Price</h2>
                                        <h2 class="text-center text-2xl text-gray-800  font-medium tracking-normal">{{ $row->discount_price }} %</h2>
                                        <h2 class="text-center text-sm text-gray-600  font-normal mt-2 mb-4 tracking-normal">Discount Offer</h2>
