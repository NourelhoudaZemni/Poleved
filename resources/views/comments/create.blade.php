...
@section('content')
    <div class="flex justify-center w-full sm:px-6">
        <div class="px-4 md:px-10 pt-6 md:pt-12 md:pb-4 pb-7">
            ...
            <form method="post" action="{{ route('comments.store', ['id' => $id ]) }}" enctype="multipart/form-data" class="mt-11">
                @csrf
                <div class="flex items-center space-x-9">
                    ...
                    <input type="email" name="email" placeholder="email@example.com" min="0"
                           class="focus:ring-2 focus:ring-gray-400 w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white  border rounded border-gray-200  "/>
                </div>
                <div class="flex items-center space-x-9">
                ...
                <div class="flex items-center space-x-9">
                    <input  type="number" name="score" placeholder="5"
                            class="focus:ring-2 focus:ring-gray-400 w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white  border rounded border-gray-200  "/>
                </div>
                <div class="flex items-center justify-between mt-9">
                    <a href="/readpost/{{ $id }}" aria-label="add user" role="button"
